...
import { useEquipmentTypes, EquipmentType } from './store';

export function EquipmentTypeSection() {
    const { types, isLoading, error, fetch, update } = useEquipmentTypes();
    ...
    const handleAddType = async () => {
        if (newType.trim()) {
            const newTypeConfig: EquipmentType = {
                name: newType.trim(),
    ...
    return (
        <Box>
            ...
            <Typography variant="body2" sx={{ mb: 2, color: 'text.secondary' }}>
                Configure the available equipment types that can be assigned to equipment
            </Typography>
